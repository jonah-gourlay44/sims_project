        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         %%                                                   %%  
         %%     1D Poisson Equation Solver for pn Diodes      %%  
         %%                                                   %%
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
T   = 300;              % [K]
ni  = 1.45E10;          % Intrinsic carrier concentration [1/cm^3]
Vt  = kb*T/q;           % [eV]
RNc = 2.82E19;          % Effective DOS of the conduction Band
dEc = Vt*log(RNc/ni);
...
title('Total Charge Density vs Position');
